...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product2.add(new Product("<p>To create globally competitive, well qualified professionals for contributing to the fulfillment of the needs of the society and to be a resource centre for generation and dissemination of technology for the socio-economic development of the society.  Also, to lay emphasis on industry, institute interaction, to develop education programs and to better the entrepreneurship skills of the students.\n" +
                "<h3 ><font color=\"#5F0D0D\">Location</h3>\n" +
        ...
        product3.add(new Product("<p>\n" +
                "<h3><font color=\"#5F0D0D\">Hostels</h3>\n" +
                "<p>\n" +
                ...
                "II A & II B.\n" +
                "<br/><br/></p>\n" +
                "<h3><font color=\"#5F0D0D\">Dispensary</h3>\n" +
                "<p>\n" +
                ...
                "\n" +
                "<h3><font color=\"#5F0D0D\">Guest House</h3>\n" +
                ...
                "\n" +
                "<h3><font color=\"#5F0D0D\">Transport Facility</h3>\n" +
                ...
                "\n" +
                "<h3><font color=\"#5F0D0D\">Internet Facilities</h3>\n" +
                ...
                "<h3><font color=\"#5F0D0D\">Security</h3>\n" +
                "<p>\n" +
        ...
        product4.add(new Product("<p>\n" +
                "<h3><font color=\"#5F0D0D\">EXAMINATION RULES<a name=\"examination\"></a></h3>\n" +
                ...
                "\n" +
                "\t\t\n" +
                "<h3><font color=\"#5F0D0D\">Library Rules<a name=\"library\"></a></h3>\n" +
                ...
                "\n" +
                "\n" +
                "<h3><font color=\"#5F0D0D\">BOOK BANK RULES<a name=\"bookbank\"></a></h3>\n" +
                "\n" +
                ...
                "<br/>\n" +
                "<h3><font color=\"#5F0D0D\">SC/ST Book Bank</h3>\n" +
                ...
                "<h3><font color=\"#5F0D0D\">Loss of Books</h3>\n" +
